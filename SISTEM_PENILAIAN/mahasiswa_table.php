...
<body class="antialiased min-h-screen relative lg:flex" x-data="{open : false}">
  ...
  <div class="relative z-0 lg:flex-grow">
    ...
    <!-- content goes here -->
    <div class="flex flex-wrap py-6 px-6">
      ...
      <div class="w-full w-12/12 sm:w-12/12 mt-4">
        <div class="px-4">
          <table class="divide-y divide-gray-300 p-2" id="dataTable">
            <thead class="bg-indigo-500">
              <tr>
                <th class=" text-xs text-white">No.</th>
                <th class=" text-xs text-white">Nim</th>
                <th class=" text-xs text-white">Nama</th>
                <th class=" text-xs text-white">Jurusan</th>
                <th class=" text-xs text-white">Kelas</th>
                <th class=" text-xs text-white">Tahun Masuk</th>
                <th class=" text-xs text-white">Edit</th>
                <th class=" text-xs text-white">Delete</th>
              </tr>
            </thead>
            <?php
            ...
            while (
              ...
              <tbody class="bg-white divide-y divide-gray-300">
                <tr class="text-center">
                  <td class=" text-sm text-indigo-800"><?= $no++; ?></td>
                  <td class=" text-sm text-indigo-800"><?= $data['nim'] ?></td>
                  <td class=" text-sm text-indigo-800"><?= $data['nama_mhs'] ?></td>
                  <td class=" text-sm text-indigo-800"><?= $data['jurusan'] ?></td>
                  <td class=" text-sm text-indigo-800"><?= $data['kelas'] ?></td>
                  <td class=" text-sm text-indigo-800"><?= $data['tahun_masuk'] ?></td>
                  <td class="text-sm text-indigo-800">
                    <a href="edit_mhs.php?id=<?= $data['id_mhs']; ?>" class="inline-block text-center">
                  ...
                  <td class="text-sm text-indigo-800">
                    <a href="proses_delete_mhs.php?id=<?= $data['id_mhs']; ?>" class="inline-block text-center" onclick="return confirm('Apakah ingin dihapus?');">
            ...
            <?php }
            ?>
            <a href="tambah_mhs.php" class="mx-14 ">
              Tambah
            </a>
          </table>
        </div>
