  ...
  <div class="relative z-0 lg:flex-grow">
    ...
    <div class="flex justify-center flex-wrap py-6 px-6">
      <div class=" w-96 w-12/12 sm:w-12/12 p-3 shadow-sm bg-gray-100 rounded">
        <form action="proses_tambah_tahun.php" method="POST">

          <div class="px-12 ">
            <label for="tahun_ajaran" class="block mb-2 text-md text-indigo-500">Tahun Ajaran</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="tahun_ajaran" id="tahun_ajaran" required>
          </div>
