      ...
      <div class=" w-96 w-12/12 sm:w-12/12 p-3 shadow-sm bg-gray-100 rounded">
        <form action="proses_tambah_mhs.php" method="POST">
          <div class="px-12 ">
            ...
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="nim" id="nim" maxlength="10" required>
          </div>
          <div class="px-12 ">
          ...
          <div class="px-12 ">
            ...
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="jurusan" id="jurusan" required>
          </div>
          <div class="px-12 ">
            <label for="kelas" class="block mb-2 text-md text-indigo-500">Kelas</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="kelas" id="kelas" required>
          </div>
          <div class="px-12 ">
            <label for="tahun_masuk" class="block mb-2 text-md text-indigo-500">Tahun Masuk</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="tahun_masuk" id="tahun_masuk" required>
          </div>
