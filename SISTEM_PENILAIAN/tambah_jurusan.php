      ...
      <div class=" w-96 w-12/12 sm:w-12/12 p-3 shadow-sm bg-gray-100 rounded">
        <form action="proses_tambah_jurusan.php" method="POST">
          ...
          <div class="px-12 ">
            ...
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="nama_jurusan" id="nama_jurusan" required>
          </div>
