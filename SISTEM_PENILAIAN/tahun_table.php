          ...
          <table class="divide-y divide-gray-300 p-2" id="dataTable">
            <thead class="bg-indigo-500">
              <tr>
                ...
                <th class=" text-xs text-white">Tahun Ajaran</th>
                <th class=" text-xs text-white">Edit</th>
                <th class=" text-xs text-white">Delete</th>
              </tr>
            </thead>
            <?php
            $query = mysqli_query($koneksi, 'SELECT * FROM tahun_ajarans');
            $no = 1;
            while (
              ...
              <tbody class="bg-white divide-y divide-gray-300">
                <tr class="text-center">
                  ...
                  <td class=" text-sm text-indigo-800"><?= $data['tahun_ajaran'] ?></td>

                  <td class="text-sm text-indigo-800">
                    <a href="edit_tahun.php?id=<?= $data['id_tahun'] ?>" class="inline-block text-center">
                  ...
                  <td class="text-sm text-indigo-800">
                    <a href="proses_delete_tahun.php?id=<?= $data['id_tahun'] ?>" class="inline-block text-center" onclick="return confirm('Apakah ingin dihapus?');">
            ...
            <?php }
            ?>
            <a href="tambah_tahun.php" class="mx-14 ">
              Tambah
            </a>
          </table>
        </div>
