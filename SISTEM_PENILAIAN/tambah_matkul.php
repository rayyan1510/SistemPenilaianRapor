    ...
    <div class="flex justify-center flex-wrap py-6 px-6">
      <div class=" w-96 w-12/12 sm:w-12/12 p-3 shadow-sm bg-gray-100 rounded">
        <form action="proses_mhs.php" method="POST">
          <div class="px-12 ">
            <label for="nama_matkul" class="block mb-2 text-md text-indigo-500">Nama Mata Kuliah</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="nama_matkul" id="nama_matkul" required>
          </div>
          <div class="px-12 ">
            <label for="nama_dosen" class="block mb-2 text-md text-indigo-500">Nama Dosen</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="nama_dosen" id="nama_dosen" required>
          </div>

          <div class="flex justify-between items-baseline px-12">
            <a href="proses_matkul.php" class="mt-4 bg-indigo-500 text-white py-2 px-6 rounded-md hover:bg-indigo-600" type="submit" name="submit" value="submit">
              Tambah
            </a>
