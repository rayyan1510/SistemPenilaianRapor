          ...
          <table class="divide-y divide-gray-300 p-2" id="dataTable">
            <thead class="bg-indigo-500">
              <tr>
                ...
                <th class=" text-xs text-white">Nama Mata Kuliah</th>
            ...
            <?php
            $query = mysqli_query($koneksi, 'SELECT * FROM matkuls');
            $no = 1;
            while (
              ...
              <tbody class="bg-white divide-y divide-gray-300">
                <tr class="text-center">
                  ...
                  <td class=" text-sm text-indigo-800"><?= $data['matkul'] ?></td>
                  <td class=" text-sm text-indigo-800"><?= $data['nama_dosen'] ?></td>

                  <td class="text-sm text-indigo-800">
                    <a href="edit_matkul.php" class="inline-block text-center">
                  ...
                  <td class="text-sm text-indigo-800">
                    <a href="delete_matkul.php" class="inline-block text-center" onclick="return confirm('Apakah ingin dihapus?');">
            ...
            <?php }
            ?>
            <a href="tambah_matkul.php" class="mx-14 ">
              Tambah
            </a>
          </table>
        </div>
