...
<body class="antialiased min-h-screen relative lg:flex" x-data="{open : false}">
  ...
  <div class="relative z-0 lg:flex-grow">
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM mahasiswas WHERE id_mhs = '$id_mhs'");
    ...
    <div class="flex justify-center flex-wrap py-6 px-6">
      <div class=" w-96 w-12/12 sm:w-12/12 p-3 shadow-sm bg-gray-100 rounded">
        <form action="proses_update_mhs.php" method="POST">
          ...
          <div class="px-12 ">
            <label for="nim" class="block mb-2 text-md text-indigo-500">Nim</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="nim" id="nim" value="<?= $data['nim'] ?>" maxlength="10" required>
          </div>
          <div class="px-12 ">
            <label for="nama" class="block mb-2 text-md text-indigo-500">Nama</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="nama" id="nama" value="<?= $data['nama_mhs'] ?>" required>
          </div>
          <div class="px-12 ">
            <label for="jurusan" class="block mb-2 text-md text-indigo-500">Jurusan</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="jurusan" id="jurusan" value="<?= $data['jurusan'] ?>" required>
          </div>
          <div class="px-12 ">
            <label for="kelas" class="block mb-2 text-md text-indigo-500">Kelas</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="kelas" id="kelas" value="<?= $data['kelas'] ?>" required>
          </div>
          <div class="px-12 ">
            <label for="tahun_masuk" class="block mb-2 text-md text-indigo-500">Tahun Masuk</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="tahun_masuk" id="tahun_masuk" value="<?= $data['tahun_masuk'] ?>" required>
          </div>
          ...
          <div class="flex justify-between items-baseline px-12">
            ...
            <a href="mahasiswa_table.php" class="text-sm hover:underline">Kembali</a>
          </div>
