          ...
          <table class="divide-y divide-gray-300 p-2" id="dataTable">
            <thead class="bg-indigo-500">
              <tr>
                ...
                <th class=" text-xs text-white">Nip</th>
                <th class=" text-xs text-white">Nama Dosen</th>
                <th class=" text-xs text-white">Edit</th>
                <th class=" text-xs text-white">Delete</th>
              </tr>
            </thead>
            <?php
            $query = mysqli_query($koneksi, 'SELECT * FROM dosens');
            $no = 1;
            while (
              ...
              <tbody class="bg-white divide-y divide-gray-300">
                <tr class="text-center">
                  ...
                  <td class=" text-sm text-indigo-800"><?= $data['nip'] ?></td>
                  <td class=" text-sm text-indigo-800"><?= $data['nama_dosen'] ?></td>

                  <td class="text-sm text-indigo-800">
                    <a href="edit_dosen.php?id=<?= $data['id_dosen']; ?>" class="inline-block text-center">
                  ...
                  <td class="text-sm text-indigo-800">
                    <a href="proses_delete_dosen.php?id=<?= $data['id_dosen'] ?>" class="inline-block text-center" onclick="return confirm('Apakah ingin dihapus?');">
            ...
            <?php }
            ?>
            <a href="tambah_dosen.php" class="mx-14 ">
              Tambah
            </a>
          </table>
        </div>
