    ...
    <div class="flex justify-center flex-wrap py-6 px-6">
      <div class=" w-96 w-12/12 sm:w-12/12 p-3 shadow-sm bg-gray-100 rounded">
        <form action="proses_tambah_dosen.php" method="POST">
          <div class="px-12 ">
            <label for="nip" class="block mb-2 text-md text-indigo-500">Nip</label>
            <input type="text" class="shadow-sm bg-gray-50 border border-indigo-800 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-indigo-800 w-64" name="nip" maxlength="10" id="nip" required>
          </div>
          <div class="px-12 ">
